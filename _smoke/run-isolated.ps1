...
param(
  [string]$Suites = 'run.js,predict-engine.js,predict-ui.js,real-ui.js,nav-groups.js,calendar.js,snapshot-sync.js,review-history.js,backtest-analysis.js,website-smoke.js'
)
